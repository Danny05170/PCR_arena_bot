CHARA_NAME = {
    ...
    1134: ['初音(夏日)', 'ハツネ(サマー)', 'Hatsune(Summer)', '水星法', '水星星法', '水法', '水睡法', '泳装星法', '泳装星星法', '泳装法', '泳装睡法', '水初音', '泳装初音'],
    1135: ['美里(夏日)', 'ミサト(サマー)', 'Misato(Summer)', '水圣母', '泳装圣母', '水美里', '泳装美里'],
    1136: ['纯(夏日)', 'ジュン(サマー)', 'Jun(Summer)', '小次郎', '水纯', '夏纯', '水黑骑'],
    1137: ['茜里(天使)', 'アカリ(エンジェル)', 'Akari(Angel)', '天使妹妹', '天使妹法', '实妹', '天法', '毛妹', '法妹弓'],
    1138: ['依里(天使)', 'ヨリ（エンジェル）', 'Yori(Angel)', '天使姐姐', '天使姐法', '实姐', '天姐', '毛姐', '法姐弓'],
    1139: ['纺希(万圣节)', 'ツムギ(ハロウィン)', 'Tsumugi(Halloween)', '万圣裁缝', '万圣蜘蛛侠', '👻🕷️', '👻🕸️'],
    1140: ['怜(万圣节)', 'レイ(ハロウィン)', 'Rei(Halloween)', '万圣剑圣', '万剑', '鬼剑', '瓜剑'],
    1141: ['茉莉(万圣节)', 'マツリ(ハロウィン)', 'Matsuri(Halloween)', '万圣跳跳虎', '万圣老虎', '万圣虎', '👻🐅'],
    1142: ['莫妮卡(神秘)', 'モニカ(マジカル)', 'Monika(Magical)', '魔二力', '神秘毛二力', '神秘毛', '神奇毛'],
    1143: ['智(神秘)', 'トモ(マジカル)', 'Tomo(Magical)', '⑨', '失了智', '神秘智', '神奇智','魔智','魔法智'],
    
    
    
    1701: ['环奈(桥本环奈)', 'カンナ(プリンセス)', 'Yui(huannai)', '桥本环奈', '环奈', '毛大力', '妈大力', '罗志祥', '静态美女'],
    ...
    9999: ['香蕉君'],
    9998: ['镜华(夏日)', 'キョウカ(サマー)', 'Kyouka(Summer)', '镜华(魔改)', '水镜华', '小仓唯(夏日)', '小仓唯(魔改)', '水仓唯', '泳装镜华'],
    
    
    
    9000: ['祐树', 'ユウキ', 'Yuuki', '骑士', '骑士君'],
    1118: ['貪吃佩可(新年)', 'ペコリーヌ(ニューイヤー)'],
    1900: ['爱梅斯', 'アメス', 'フィオ', '菲欧', 'Amesu', 'Fio'],
    1907: ['鬼道大古', '大吾', '大古', 'Taigo', 'タイゴ'],
    1909: ['涅比亚', 'Nebia', 'ネビア', 'Nevia'],
    1910: ['真崎', 'マサキ', 'Masaki'],
    1911: ['米涅尔', 'ミネル', 'MineruBeta', '米涅尔β', 'Mineru', 'ミネルβ'],
    1914: ['豪绅', 'Goushin', 'ゴウシン'],
    1915: ['克里吉塔', 'Kurejikku', 'クレジック'],
    1916: ['基洛', 'Kiiro', 'キイロ'],
    1917: ['善', 'Seen', 'ゼーン'],
    1918: ['兰法', 'ランファ', 'Ranfa'],
    1919: ['阿佐尔德', 'Anzoorudo', 'アンゾールド'],
    1920: ['美空', 'Misora', 'ミソラ']
}
